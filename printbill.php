...
<div class="container">
    <div class="jumbotron">
        <h2 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Car Returned</h2>
    </div>
</div>
<br>

<h2 class="text-center"> Thank you for visiting Athiba Car Rentals! We wish you have a safe ride. </h2>
